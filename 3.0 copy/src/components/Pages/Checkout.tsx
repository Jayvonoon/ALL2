// Checkout page
import React, {useContext} from "react"; //Added useContext Justyn
import { useNavigate } from 'react-router-dom';
import { useState } from 'react';
import { useShoppingCart } from '../context/ShoppingCartContext.tsx';
import { CartItem } from '../Page_comp/CartItem.tsx';
...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      console.log('Selected place:', selectedPlace); //Checking whether place name is passed down Justyn
