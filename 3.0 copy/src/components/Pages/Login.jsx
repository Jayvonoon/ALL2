...
export const Login = (props) => 
{
    ...
    const handleSubmit = async(e) => 
    {
        ...
        if (response.ok){
            localStorage.setItem('access_token', responseData.access_token);  // Store the token
...
//                 <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="user@domain.com" id="email" name="email" />
//                 <label htmlFor="password">Password</label>
//                 <input value={pass} onChange={(e) => setPass(e.target.value)} type="password" placeholder="********" id="password" name="password" style = {{marginBottom:"40px"}} />
//                 <button type="submit" style={{ backgroundColor: "#4CAF50", border: "none", color: "white", padding: "15px 32px", textAlign: "center", textDecoration: "none", display: "inline-block", fontSize: "16px", margin: "10px 6px", transitionDuration: "0.4s", cursor: "pointer" }}>Log In</button>
//             </form>
//             <div>
//                 <span>Don't have an account? </span>
//                 <button className="link-btn" style={{ backgroundColor: "transparent", border: "none", padding: 0, font: "inherit", cursor: "pointer", textDecoration: "underline" }} onClick={() => navigate('/register')}>Sign Up</button>
