  ...
  return (
    <AppBar position="static">
      <Toolbar className={classes.toolbar}>
        ...
        {/* Add Minigame button here
        <Link to="/minigame" style={{ textDecoration: 'none', color: 'orange' }}>
          <Typography variant="button" className={classes.minigameButton} >
            Minigame
          </Typography>
        </Link> */}
